...
loop
    ...
    if mouse_x >= steveFutureHitbox_x1 - 8 and mouse_x <= steveFutureHitbox_x2 + 8 and mouse_y >= steveFutureHitbox_y1 - 8 and mouse_y <= steveFutureHitbox_y2 + 8 or mouse_x >= steveHitbox_x1 - 8 and mouse_x <= steveHitbox_x2 + 8 and mouse_y >= steveHitbox_y1 - 8 and mouse_y <= steveHitbox_y2 + 8then
	allowBlockPlace := false
